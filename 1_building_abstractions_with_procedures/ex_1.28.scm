...
(define (nontrivial-square-root-check a n)
    (cond ((= a 1) true)
          ((= a (- n 1)) true)
          (else (not (= (remainder (square a)
                        n)
                   1)))))

(define (square-check a n)
    (if (nontrivial-square-root-check a n) 
      (* a a) 
      0))
...
(fast-prime? 36 100) ;#f
(fast-prime? 1999 1000) ;#t
(fast-prime? 10037 10000) ;#t
(fast-prime? 19999 1000) ;#f

;Carmichael numbers
(fast-prime? 561 1000)  ;#f
(fast-prime? 1105 10000) ;#f
(fast-prime? 1729 10000) ;#f
(fast-prime? 2465 10000) ;#f
(fast-prime? 2821 10000) ;#f
(fast-prime? 6601 10000) ;#f